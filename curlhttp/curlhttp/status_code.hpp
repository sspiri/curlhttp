#ifndef CURLHTTP_STATUS_CODE_HPP
#define CURLHTTP_STATUS_CODE_HPP
...
namespace curlhttp{
    ...
    inline std::string status_code_string(status_code code){
        switch(code){
        ...
        case status_code::accepted:
            return "Accepted";
        case status_code::nonauthoritative_information:
        ...
        case status_code::requesturi_too_long:
        ...
        case status_code::network_connect_timeout_error:
            return "Network Connect Timeout Error";

        default:
            return "Unknown status code (" + std::to_string((int)code) + ')';
        }
    }
}
